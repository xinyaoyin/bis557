...
Check KKT condition function   
```{r}
#Check current KKT conditions (Reference to Textbook)
...
#Check variables to see if they violate KKT condition
#x:a numeric data matrix
#y:response vector
#return alogical vector indicating whether the KKT conditions have been violated
#If KKT condition is violated, return a vector that contains at least one TRUE
#If KKT condition is not violated, return a vector of FALSEs
...
```
## We get FALSE for all coefficient estimates. This indicates that no KKT condition has been violated. 
